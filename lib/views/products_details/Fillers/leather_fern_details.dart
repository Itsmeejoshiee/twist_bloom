...
class LeatherFernDetails extends StatefulWidget {
  ...
  @override
  _LeatherFernDetails createState() => _LeatherFernDetails();
}

class _LeatherFernDetails extends State<LeatherFernDetails> {
