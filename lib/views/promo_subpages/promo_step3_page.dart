...
import 'package:twist_bloom/widgets/product.dart'; // Make sure this is correctly imported
...
class _PromoStep3Page extends State<PromoStep3Page> {
  List<Map<String, dynamic>> products = [
    {
      'imageUrl': 'assets/icon/product/kraft_board.jpg',
      'title': 'Kraft Board',
      'price': 0.0,
    },
    {
    ...
    {
      'imageUrl': 'assets/icon/product/navy_blue.jpg',
      'title': 'Navy Blue',
      'price': 0.0,
    },
    {
      'imageUrl': 'assets/icon/product/lime_green.jpg',
      'title': 'Lime Green',
      'price': 0.0,
    },
    {
    ...
    {
      'imageUrl': 'assets/icon/product/yellow_paper.jpg',
      'title': 'Milky Yellow',
      'price': 0.0,
    },
    {
          ...
          children: [
            FloatingActionButton.extended(
              ...
              onPressed: selectedProduct != null
                  ? () {
                // Handle the basket check with selected product
